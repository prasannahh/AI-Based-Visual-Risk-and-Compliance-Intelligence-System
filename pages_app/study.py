...
def render():
    ...
    with st.container(border=True):
        ...
        if weekly.empty or weekly["hours"].sum() == 0:
            ...
            fig = go.Figure(
                go.Bar(x=weekly["day"], y=weekly["hours"], marker_color="#22d3ee")
            )
            fig.update_layout(
                ...
                xaxis=dict(color="#cbd5e1", tickfont=dict(color="#cbd5e1"), title_font=dict(color="#cbd5e1")),
                yaxis=dict(color="#cbd5e1", tickfont=dict(color="#cbd5e1"), title_font=dict(color="#cbd5e1")),
    ...
    with st.container(border=True):
        ...
        with ai_tab[0]:
            ...
            fig.update_layout(
                ...
                xaxis=dict(color="#cbd5e1", tickfont=dict(color="#cbd5e1"), title_font=dict(color="#cbd5e1")),
                yaxis=dict(range=[0, 100], color="#cbd5e1", tickfont=dict(color="#cbd5e1"), title_font=dict(color="#cbd5e1")),
            )
            st.plotly_chart(fig, width='stretch')
