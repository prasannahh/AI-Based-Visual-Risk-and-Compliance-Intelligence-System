...
<p style="color:#64748b;font-size:0.8rem;">Placeholder contact info for demo purposes.</p>
</div>
"""
...
def render_header():
    st.markdown(
        ...
        <div class="dt-header-wrap">
            <div class="dt-header-title">🧬 {APP_TITLE}</div>
            <div class="dt-header-sub">Simulate • Optimize • Evolve</div>
        </div>
        """,
